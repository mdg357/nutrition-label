...
(function ($) {
    ...
    function cleanSettings(settings) {
        var numericIndex = [
            ...
            'calorieIntake', 'dailyValueTotalFat', 'dailyValueSatFat', 'dailyValueCholesterol', 'dailyValueSodium', 'dailyValuePotassium',
            'dailyValueCarb', 'dailyValueFiber', 'valueServingSize', 'valueServingWeightGrams', 'valueServingPerContainer', 'valueCalories',
            ...
            'valueCalcium', 'valueIron', 'valuePhosphorus', 'valueMagnesium', 'valueManganese', 'valueCol1CalorieDiet', 'valueCol2CalorieDiet', 'valueCol1DietaryTotalFat',
            'valueCol2DietaryTotalFat', 'valueCol1DietarySatFat', 'valueCol2DietarySatFat', 'valueCol1DietaryCholesterol',
            'valueCol2DietaryCholesterol', 'valueCol1DietarySodium', 'valueCol2DietarySodium', 'valueCol1DietaryPotassium',
            'valueCol2DietaryPotassium', 'valueCol1DietaryTotalCarb', 'valueCol2DietaryTotalCarb', 'valueCol1Dietary', 'valueCol2Dietary',
            'valueServingUnitQuantity', 'scrollLongItemNamePixel, decimalPlacesForQuantityTextbox'
        ];
    ...
    function UpdateNutritionValueWithMultiplier(settings) {
        var nutritionIndex = [
            ...
            'valueVitaminC', 'valueCalcium', 'valueIron', 'valuePhosphorus', 'valueMagnesium', 'valueManganese'
        ];
    ...
    function init(settings, $elem) {
        //merge the default settings with the user supplied settings
        ...
        //initialize the nutrition label and create / recreate it
        var nutritionLabel = new NutritionLabel($updatedsettings, $elem);
        $elem.html(nutritionLabel.generate());


        //scroll the ingredients of the inner height is > $settings.scrollHeightComparison
    ...
    //Total Carbohydrate, Dietary Fiber, Sugar and Protein rounding rule
    function roundVitaminsCalciumIronOther(toRound) {
        if (toRound > 0) {
            if (toRound < 10)
        ...
        generate: function () {
            ...
            if ($this.settings.showServingUnitQuantity) {
                ...
                if ($this.settings.originalServingUnitQuantity > 0) {
                    ...
                    if ($this.settings.valueServingWeightGrams > 0)
                        ...
                        parseFloat($this.settings.valueServingWeightGrams.toFixed($this.settings.decimalPlacesForNutrition)) + 'g)</div>\n';
            ...
            if ($this.settings.showTotalFat) {
                ...
                nutritionLabel += $this.settings.naTotalFat ?
                    ...
                    parseFloat(
                        parseFloat(
                            (
                                ($this.settings.allowFDARounding ? roundFatRule($this.settings.valueTotalFat) : $this.settings.valueTotalFat) / ($this.settings.dailyValueTotalFat == 0 ? 1 : $this.settings.dailyValueTotalFat * calorieIntakeMod)
                            ) * 100
            ...
            if ($this.settings.showSatFat) {
                ...
                nutritionLabel += $this.settings.naSatFat ?
                    ...
                    parseFloat(
                        parseFloat(
                            (
                                ($this.settings.allowFDARounding ? roundFatRule($this.settings.valueSatFat) : $this.settings.valueSatFat) / ($this.settings.dailyValueSatFat == 0 ? 1 : $this.settings.dailyValueSatFat * calorieIntakeMod)
                            ) * 100
                        ).toFixed($this.settings.decimalPlacesForDailyValues)
                    ) + '</b>%';
                nutritionLabel += '</div>\n';
            ...
            if ($this.settings.showCholesterol) {
                ...
                nutritionLabel += $this.settings.naCholesterol ?
                    ...
                    parseFloat(
                        parseFloat(
                            (
                                ($this.settings.allowFDARounding ? roundCholesterolRule($this.settings.valueCholesterol) : $this.settings.valueCholesterol) / ($this.settings.dailyValueCholesterol == 0 ? 1 : $this.settings.dailyValueCholesterol * calorieIntakeMod)
                            ) * 100
                        ).toFixed($this.settings.decimalPlacesForDailyValues)
                    ) + '</b>%';
                nutritionLabel += '</div>\n';
            ...
            if ($this.settings.showSodium) {
                ...
                nutritionLabel += $this.settings.naSodium ?
                    ...
                    parseFloat(
                        parseFloat(
                            (
                                ($this.settings.allowFDARounding ? roundSodiumRule($this.settings.valueSodium) : $this.settings.valueSodium) / ($this.settings.dailyValueSodium == 0 ? 1 : $this.settings.dailyValueSodium * calorieIntakeMod)
                            ) * 100
                        ).toFixed($this.settings.decimalPlacesForDailyValues)
                    ) + '</b>%';
                nutritionLabel += '</div>\n';
            ...
            if ($this.settings.showPotassium) {
                ...
                nutritionLabel += $this.settings.naPotassium ?
                    ...
                    parseFloat(
                        parseFloat(
                            (
                                ($this.settings.allowFDARounding ? roundPotassiumRule($this.settings.valuePotassium) : $this.settings.valuePotassium) / ($this.settings.dailyValuePotassium == 0 ? 1 : $this.settings.dailyValuePotassium * calorieIntakeMod)
                            ) * 100
                        ).toFixed($this.settings.decimalPlacesForDailyValues)
                    ) + '</b>%';
                nutritionLabel += '</div>\n';
            ...
            if ($this.settings.showTotalCarb) {
                ...
                nutritionLabel += $this.settings.naTotalCarb ?
                    ...
                    parseFloat(
                        parseFloat(
                            (
                                ($this.settings.allowFDARounding ? roundCarbFiberSugarProteinRule($this.settings.valueTotalCarb) : $this.settings.valueTotalCarb) / ($this.settings.dailyValueCarb == 0 ? 1 : $this.settings.dailyValueCarb * calorieIntakeMod)
                            ) * 100
                        ).toFixed($this.settings.decimalPlacesForDailyValues)
                    ) + '</b>%';
                nutritionLabel += '</div>\n';
            ...
            if ($this.settings.showFibers) {
                ...
                nutritionLabel += $this.settings.naFibers ?
                    ...
                    parseFloat(
                        parseFloat(
                            (
                                ($this.settings.allowFDARounding ? roundCarbFiberSugarProteinRule($this.settings.valueFibers) : $this.settings.valueFibers) / ($this.settings.dailyValueFiber == 0 ? 1 : $this.settings.dailyValueFiber * calorieIntakeMod)
                            ) * 100
                        ).toFixed($this.settings.decimalPlacesForDailyValues)
                    ) + '</b>%';
                nutritionLabel += '</div>\n';
            ...
            if ($this.settings.showVitaminA) {
                ...
                nutritionLabel += $this.settings.naVitaminA ?
                    ...
                    (
                        $this.settings.allowFDARounding ?
                        roundVitaminsCalciumIronOther($this.settings.valueVitaminA) :
            ...
            if ($this.settings.showVitaminC) {
                ...
                nutritionLabel += $this.settings.naVitaminC ?
                    ...
                    (
                        $this.settings.allowFDARounding ?
                        roundVitaminsCalciumIronOther($this.settings.valueVitaminC) :
            ...
            if ($this.settings.showCalcium) {
                ...
                nutritionLabel += $this.settings.naCalcium ?
                    ...
                    (
                        $this.settings.allowFDARounding ?
                        roundVitaminsCalciumIronOther($this.settings.valueCalcium) :
            ...
            if ($this.settings.showIron) {
                ...
                nutritionLabel += $this.settings.naIron ?
                    ...
                    (
                        $this.settings.allowFDARounding ?
                        roundVitaminsCalciumIronOther($this.settings.valueIron) :
            ...
            if ($this.settings.showPhosphorus) {
                nutritionLabel += tab1 + '<div class="line phosphorus">\n';
                nutritionLabel += tab2 + '<div class="dv">';
                nutritionLabel += $this.settings.naPhosphorus ?
                    naValue :
                    (
                        $this.settings.allowFDARounding ?
                        roundVitaminsCalciumPhosphorusOther($this.settings.valuePhosphorus) :
                        parseFloat($this.settings.valuePhosphorus.toFixed($this.settings.decimalPlacesForNutrition))
                    ) + $this.settings.unitPhosphorus;
                nutritionLabel += '</div>\n';

                nutritionLabel += tab2 + $this.settings.textPhosphorus + '\n';
                nutritionLabel += tab1 + '</div>\n';
            }

            if ($this.settings.showMagnesium) {
                nutritionLabel += tab1 + '<div class="line magnesium">\n';
                nutritionLabel += tab2 + '<div class="dv">';
                nutritionLabel += $this.settings.naMagnesium ?
                    naValue :
                    (
                        $this.settings.allowFDARounding ?
                        roundVitaminsCalciumMagnesiumOther($this.settings.valueMagnesium) :
            ...
            if ($this.settings.showManganese) {
                nutritionLabel += tab1 + '<div class="line manganese">\n';
                nutritionLabel += tab2 + '<div class="dv">';
                nutritionLabel += $this.settings.naManganese ?
                    naValue :
                    (
                        $this.settings.allowFDARounding ?
                        roundVitaminsCalciumManganeseOther($this.settings.valueManganese) :
